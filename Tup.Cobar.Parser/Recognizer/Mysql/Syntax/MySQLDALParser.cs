...
using DalShowColumns = Tup.Cobar.Parser.Ast.Stmt.Dal.ShowColumns;
using DalShowIndex = Tup.Cobar.Parser.Ast.Stmt.Dal.ShowIndex;
using DalShowProfile = Tup.Cobar.Parser.Ast.Stmt.Dal.ShowProfile;
    ...
    public class MySQLDALParser : MySQLParser
    {
        ...
        private string GetStringValue()
        {
            ...
            switch (lexer.Token())
            {
                case MySQLToken.Identifier:
                    {
                        name = Tup.Cobar.Parser.Ast.Expression.Primary.Identifier.UnescapeName(lexer.StringValue());
                        lexer.NextToken();
                        return name;
                    }
        ...
        /// <returns>
        ///
        /// <see cref="Tup.Cobar.Parser.Ast.Stmt.Dal.DALSetStatement"/>
        /// or
        /// <see cref="Tup.Cobar.Parser.Ast.Stmt.Mts.MTSSetTransactionStatement"/>
        /// </returns>
        /// <exception cref="System.Data.Sql.SQLSyntaxErrorException"/>
