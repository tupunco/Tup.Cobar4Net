...
namespace Tup.Cobar.Parser.Ast.Fragment
{
    ...
    public class OrderBy : ASTNode
    {
        ...
        public OrderBy(Tup.Cobar.Parser.Ast.Expression.Expression expr, SortOrder order)
        {
        ...
        public virtual Tup.Cobar.Parser.Ast.Fragment.OrderBy AddOrderByItem(Tup.Cobar.Parser.Ast.Expression.Expression
