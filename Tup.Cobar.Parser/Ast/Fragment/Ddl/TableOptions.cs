...
namespace Tup.Cobar.Parser.Ast.Fragment.Ddl
{
	...
	public class TableOptions : ASTNode
	{
		...
		private Tup.Cobar.Parser.Ast.Expression.Expression autoIncrement;

		private Tup.Cobar.Parser.Ast.Expression.Expression avgRowLength;
		...
		private Tup.Cobar.Parser.Ast.Expression.Expression keyBlockSize;

		private Tup.Cobar.Parser.Ast.Expression.Expression maxRows;

		private Tup.Cobar.Parser.Ast.Expression.Expression minRows;
		...
		public virtual Tup.Cobar.Parser.Ast.Expression.Expression GetAutoIncrement()
		{
			return autoIncrement;
		}

		public virtual void SetAutoIncrement(Tup.Cobar.Parser.Ast.Expression.Expression autoIncrement
			)
		{
			this.autoIncrement = autoIncrement;
		}

		public virtual Tup.Cobar.Parser.Ast.Expression.Expression GetAvgRowLength()
		{
			return avgRowLength;
		}

		public virtual void SetAvgRowLength(Tup.Cobar.Parser.Ast.Expression.Expression avgRowLength
			)
		{
		...
		public virtual void SetKeyBlockSize(Tup.Cobar.Parser.Ast.Expression.Expression keyBlockSize
			)
		{
			this.keyBlockSize = keyBlockSize;
		}

		public virtual Tup.Cobar.Parser.Ast.Expression.Expression GetMaxRows()
		{
			return maxRows;
		}

		public virtual void SetMaxRows(Tup.Cobar.Parser.Ast.Expression.Expression maxRows
			)
		{
			this.maxRows = maxRows;
		}

		public virtual Tup.Cobar.Parser.Ast.Expression.Expression GetMinRows()
		{
			return minRows;
		}

		public virtual void SetMinRows(Tup.Cobar.Parser.Ast.Expression.Expression minRows
			)
		{
