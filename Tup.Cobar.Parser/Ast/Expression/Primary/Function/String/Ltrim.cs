...
namespace Tup.Cobar.Parser.Ast.Expression.Primary.Function.String
{
    ...
    {
        public Ltrim(IList<Tup.Cobar.Parser.Ast.Expression.Expression> arguments)
            : base("LTRIM", arguments)
        {
        }
        ...
        public override FunctionExpression ConstructFunction(IList<Tup.Cobar.Parser.Ast.Expression.Expression
            > arguments)
        {
            return new Tup.Cobar.Parser.Ast.Expression.Primary.Function.String.Ltrim(arguments
                );
        }
    }
}