...
namespace Tup.Cobar.Parser.Ast.Expression.Primary.Function.String
{
    ...
    {
        public Left(IList<Tup.Cobar.Parser.Ast.Expression.Expression> arguments)
            : base("LEFT", arguments)
        {
        }
        ...
        public override FunctionExpression ConstructFunction(IList<Tup.Cobar.Parser.Ast.Expression.Expression
            > arguments)
        {
            return new Tup.Cobar.Parser.Ast.Expression.Primary.Function.String.Left(arguments
                );
        }
    }
}