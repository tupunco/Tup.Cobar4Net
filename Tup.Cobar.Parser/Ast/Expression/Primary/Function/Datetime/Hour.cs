...
namespace Tup.Cobar.Parser.Ast.Expression.Primary.Function.Datetime
{
    ...
    {
        public Hour(IList<Tup.Cobar.Parser.Ast.Expression.Expression> arguments)
            : base("HOUR", arguments)
        {
        }
        ...
        public override FunctionExpression ConstructFunction(IList<Tup.Cobar.Parser.Ast.Expression.Expression
            > arguments)
        {
            return new Tup.Cobar.Parser.Ast.Expression.Primary.Function.Datetime.Hour(arguments
                );
        }
    }
}