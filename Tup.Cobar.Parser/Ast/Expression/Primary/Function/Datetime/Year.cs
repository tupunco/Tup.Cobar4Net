...
namespace Tup.Cobar.Parser.Ast.Expression.Primary.Function.Datetime
{
    ...
    {
        public Year(IList<Tup.Cobar.Parser.Ast.Expression.Expression> arguments)
            : base("YEAR", arguments)
        {
        }
        ...
        public override FunctionExpression ConstructFunction(IList<Tup.Cobar.Parser.Ast.Expression.Expression
            > arguments)
        {
            return new Tup.Cobar.Parser.Ast.Expression.Primary.Function.Datetime.Year(arguments
                );
        }
    }
}