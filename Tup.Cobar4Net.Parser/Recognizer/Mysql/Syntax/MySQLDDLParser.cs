...
using DdlDatatype = Tup.Cobar4Net.Parser.Ast.Fragment.Ddl.Datatype.DataType;
...
namespace Tup.Cobar4Net.Parser.Recognizer.Mysql.Syntax
{
    ...
    public class MySQLDDLParser : MySQLParser
    {
                                            ...
                                            case SpecialIdentifier.Policy:
                                                {
                                                    ...
                                                    for (int j = 0; lexer.Token() != MySQLToken.PuncRightParen; ++j)
                                                    {
                                                        ...
                                                        Tup.Cobar4Net.Parser.Ast.Expression.Expression val = exprParser.Expression();
        ...
        private DDLAlterTableStatement AlterTable(DDLAlterTableStatement stmt)
        {
            ...
            Tup.Cobar4Net.Parser.Ast.Expression.Expression expr = null;
        ...
        private IndexColumnName IndexColumnName()
        {
            ...
            Tup.Cobar4Net.Parser.Ast.Expression.Expression len = null;
            if (lexer.Token() == MySQLToken.PuncLeftParen)
            {
                lexer.NextToken();
        ...
        private DdlDatatype DataType()
        {
            ...
            bool zerofill = false;
            bool binary = false;
            Tup.Cobar4Net.Parser.Ast.Expression.Expression length = null;
            Tup.Cobar4Net.Parser.Ast.Expression.Expression decimals = null;
            Identifier charSet = null;
            Identifier collation = null;
            IList<Tup.Cobar4Net.Parser.Ast.Expression.Expression> collectionVals = null;
            switch (lexer.Token())
            {
                ...
                case MySQLToken.KwSet:
                    {
                        ...
                        for (int i = 0; lexer.Token() != MySQLToken.PuncRightParen; ++i)
                        {
                            ...
                            {
                                collectionVals = new List<Tup.Cobar4Net.Parser.Ast.Expression.Expression>(2);
                            }
        ...
        private DdlColumnDefinition ColumnDefinition()
        {
            ...
            bool notNull = false;
            Tup.Cobar4Net.Parser.Ast.Expression.Expression defaultVal = null;
            ...
            if (lexer.Token() == MySQLToken.KwDefault)
            {
                ...
                if (!(defaultVal is Tup.Cobar4Net.Parser.Ast.Expression.Primary.Literal.Literal))
                {
