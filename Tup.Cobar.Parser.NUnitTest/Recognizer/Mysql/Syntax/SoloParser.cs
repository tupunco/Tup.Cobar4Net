...
namespace Tup.Cobar.Parser.Recognizer.Mysql.Syntax
{
    ...
    internal class SoloParser : MySQLParser
    {
        ...
        public virtual Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Refs Refs()
        {
            Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Refs refs = new Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Refs
                ();
            for (;;)
            {
                Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref @ref = Ref();
                refs.AddRef(@ref);
        ...
        /// <exception cref="System.Data.Sql.SQLSyntaxErrorException"/>
        public virtual Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref BuildRef(Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref
             first)
        {
            for (; lexer.Token() == MySQLToken.KwJoin;)
            {
                lexer.NextToken();
                Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref temp = Factor();
        ...
        /// <exception cref="System.Data.Sql.SQLSyntaxErrorException"/>
        public virtual Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref Ref()
        {
            return BuildRef(Factor());
        }

        /// <exception cref="System.Data.Sql.SQLSyntaxErrorException"/>
        public virtual Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref Factor()
        {
            string alias;
            if (lexer.Token() == MySQLToken.PuncLeftParen)
            {
                lexer.NextToken();
                Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref queryRefs = RefsOrQuery();
            ...
            if (lexer.Token() == MySQLToken.KwAs)
            {
                ...
                alias = lexer.StringValue();
                lexer.NextToken();
                return new Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Factor(tableName, alias);
            }
            return new Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Factor(tableName, null);
        }

        /// <summary>first <code>(</code> has been consumed</summary>
        /// <exception cref="System.Data.Sql.SQLSyntaxErrorException"/>
        public virtual Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref RefsOrQuery()
        {
            Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Ref temp;
            Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Refs rst;
            Union u;
            switch (lexer.Token())
            {
            ...
            if (lexer.Token() == MySQLToken.PuncComma)
            {
                rst = new Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Refs();
                rst.AddRef(temp);
        ...
        public static void Main(string[] args)
        {
            ...
            lexer.NextToken();
            Tup.Cobar.Parser.Recognizer.Mysql.Syntax.SoloParser p = new Tup.Cobar.Parser.Recognizer.Mysql.Syntax.SoloParser
                (lexer);
            Tup.Cobar.Parser.Recognizer.Mysql.Syntax.Refs refs = p.Refs();
