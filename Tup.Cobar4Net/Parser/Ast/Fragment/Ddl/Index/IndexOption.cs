...
namespace Tup.Cobar4Net.Parser.Ast.Fragment.Ddl.Index
{
    ...
    {
        private readonly Tup.Cobar4Net.Parser.Ast.Expression.Expression keyBlockSize;
        ...
        public IndexOption(Tup.Cobar4Net.Parser.Ast.Expression.Expression keyBlockSize)
        {
        ...
        public virtual Tup.Cobar4Net.Parser.Ast.Expression.Expression GetKeyBlockSize()
        {
            return keyBlockSize;
        }
