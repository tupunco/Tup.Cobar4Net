...
namespace Tup.Cobar4Net.Parser.Ast.Expression.Comparison
{
    ...
    /// </author>
    public class ComparisionNotEqualsExpression : BinaryOperatorExpression
    {
        public ComparisionNotEqualsExpression(IExpression leftOprand, IExpression rightOprand)
