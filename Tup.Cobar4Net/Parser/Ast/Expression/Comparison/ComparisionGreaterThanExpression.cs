...
namespace Tup.Cobar4Net.Parser.Ast.Expression.Comparison
{
    ...
    /// </author>
    public class ComparisionGreaterThanExpression : BinaryOperatorExpression
    {
        public ComparisionGreaterThanExpression(IExpression leftOprand, IExpression rightOprand)
